...
const Footer = () => {
    return (
        <div className="w-full h-auto bg-second pt-[20px] text-[#ffff] text-13px tl:text-13px pt-2 pb-4  px-[10px]  ">
                            ...
                            return (
                                ...
                                >
                                    <Link
                                        ...
                                        className="uppercase hover:text-hover"
                                    >
                                        <li className="transition-all text-white">
                                            {
                                                item.display
                                            }
                                        </li>
